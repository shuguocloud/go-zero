...
import (
	...
	"github.com/shuguocloud/go-zero/tools/goctl/api/apigen"
	"github.com/shuguocloud/go-zero/tools/goctl/api/dartgen"
	"github.com/shuguocloud/go-zero/tools/goctl/api/docgen"
	"github.com/shuguocloud/go-zero/tools/goctl/api/format"
	"github.com/shuguocloud/go-zero/tools/goctl/api/gogen"
	"github.com/shuguocloud/go-zero/tools/goctl/api/javagen"
	"github.com/shuguocloud/go-zero/tools/goctl/api/ktgen"
	"github.com/shuguocloud/go-zero/tools/goctl/api/new"
	"github.com/shuguocloud/go-zero/tools/goctl/api/tsgen"
	"github.com/shuguocloud/go-zero/tools/goctl/api/validate"
	"github.com/shuguocloud/go-zero/tools/goctl/configgen"
	"github.com/shuguocloud/go-zero/tools/goctl/docker"
	"github.com/shuguocloud/go-zero/tools/goctl/kube"
	"github.com/shuguocloud/go-zero/tools/goctl/model/mongo"
	model "github.com/shuguocloud/go-zero/tools/goctl/model/sql/command"
	"github.com/shuguocloud/go-zero/tools/goctl/plugin"
	rpc "github.com/shuguocloud/go-zero/tools/goctl/rpc/cli"
	"github.com/shuguocloud/go-zero/tools/goctl/tpl"
	"github.com/shuguocloud/go-zero/tools/goctl/upgrade"
			...
			Subcommands: []cli.Command{
				...
				},
				{
					...
					Flags: []cli.Flag{
						...
						cli.StringFlag{
							Name:  "style",
							Usage: "the file naming format, see [https://github.com/shuguocloud/go-zero/tree/master/tools/goctl/config/readme.md]",
						},
						cli.StringFlag{
							Name:  "home",
