...
* usermodel.go
  ...
  import (
      ...
      cachec "github.com/shuguocloud/go-zero/core/stores/cache"
      "github.com/shuguocloud/go-zero/core/stores/mongoc"
  )
...
OPTIONS:
   ...
   --style value           the file naming format, see [https://github.com/shuguocloud/go-zero/tree/master/tools/goctl/config/readme.md]
