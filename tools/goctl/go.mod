module github.com/shuguocloud/go-zero/tools/goctl
...
require (
	...
	github.com/shuguocloud/antlr v0.0.1
	github.com/shuguocloud/ddl-parser v1.0.5
	github.com/shuguocloud/go-zero v1.8.0
