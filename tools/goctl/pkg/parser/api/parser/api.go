...
import (
	...
	"github.com/shuguocloud/go-zero/tools/goctl/pkg/parser/api/ast"
	"github.com/shuguocloud/go-zero/tools/goctl/pkg/parser/api/importstack"
	"github.com/shuguocloud/go-zero/tools/goctl/pkg/parser/api/placeholder"
	"github.com/shuguocloud/go-zero/tools/goctl/pkg/parser/api/token"
)
